...
import {AccountLogin, AccountRegister, CompanyRegister} from 'src/app/shared/models/accounts';
...
export class LoginRegisterService {
    ...
    CompanyRegister(model: CompanyRegister): Observable<ReturnedResponse<CompanyRegister>> {
