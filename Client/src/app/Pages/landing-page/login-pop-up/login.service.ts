...
export class LoginService {
    ...
    Login(model: AccountLogin): Observable<ReturnedResponse<AccountLogin>> {
        return this.http.post<ReturnedResponse<AccountLogin>>(`${localUrl}/${this.controller}/login`, model);
    }
}
